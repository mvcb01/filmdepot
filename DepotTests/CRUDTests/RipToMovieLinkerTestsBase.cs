...
namespace DepotTests.CRUDTests
{
    ...
    public class RipToMovieLinkerTestsBase
    {
        ...
        public RipToMovieLinkerTestsBase()
        {
            ...
            this._rateLimitConfigMock.SetupGet(pol => pol.NumberOfExecutions).Returns(2);
            this._rateLimitConfigMock.SetupGet(pol => pol.PerTimeSpan).Returns(TimeSpan.FromMilliseconds(100));

            this._retryConfigMock.SetupGet(pol => pol.RetryCount).Returns(10);
            this._retryConfigMock.SetupGet(pol => pol.SleepDuration).Returns(TimeSpan.FromMilliseconds(100));
